    ...
    <div className="min-h-screen flex" data-testid="login-page">
      ...
      <div className="hidden lg:flex lg:w-1/2 login-split-left relative">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12">
          ...
          <p className="text-xl text-slate-300 mb-8 text-center">Security Dashboard</p>
          <div className="max-w-md text-center">
            <p className="text-slate-400 text-lg leading-relaxed">
              Protecting Acadia University with real-time emergency monitoring, 
              incident management, and campus safety coordination.
            </p>
          </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500">
              {isRegister 
                ? 'Register for security dashboard access' 
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  name="email"
                  type="email"
                  placeholder="officer@acadiau.ca"
